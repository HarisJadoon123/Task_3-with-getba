function submission(e) {
    ...
    if (email.value.trim() === "")                                      //Emial Validation
    {
    ...
    if (cnic.value.trim() === "")                                      //CNIC Validation
    {
    ...
    if (picture.value.trim() === "")                             //Picture Validation
    {
